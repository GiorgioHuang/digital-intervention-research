...
**What remains open, in one place** (rechecked 2026-08-16): the absence of a single strong-authentication bar per screen, and the **per-item epistemic tags** of §1.2 — which stay unbuilt on purpose, because there is no field to record one in and an invented label is worse than an absent one.
