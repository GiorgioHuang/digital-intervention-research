...
**Version:** 1.1  
**Status:** Revised Research and Evaluation Architecture Baseline  
...
**Supersedes:** Document 11 — Research & Evaluation Framework v1.0  
...
- evaluating Life Story, Governed Community, Platform Public participation, Open Matching, Connections, messaging and AI-supported intervention components;
...
- Governed Community and Platform Public participation evaluation;
...
Evidence Decision and Evidence Snapshot
        ↓
Study Concept and Causal Model
        ↓
Intervention Version and Configuration
        ↓
Protocol Version
        ↓
Governance, Ethics and Approval Records
        ↓
...
Intervention Assignment
        ↓
Delivery, Exposure, Adaptation and Fidelity
        ↓
Life Story, Community, Open Matching and Human Connection
        ↓
Assessment, Observation, Safety and Moderation
        ↓
Dataset Definition, Quality Review and Dataset Lock
        ↓
Approved Analysis Plan and Analysis Run
        ↓
Interpretation Record
        ↓
Research Finding
        ↓
Retain • Revise • Restrict • Replicate • Expand
Suspend • Retire • Continue Exploratory Research
```

The lifecycle may be iterative. A feasibility study may lead to intervention revision before a pilot. A pilot may reveal that the measurement strategy is inappropriate. A completed evaluation may generate a new Research Question.
...
- Governed Community and social-connection study;
...
### 9.1 Design Selection

Study design should be selected according to the Research Question, intervention maturity, ethical constraints, operational feasibility, and evidence needs.

The platform must not assume that a randomised controlled trial is always the correct first design.

### 9.2 Intervention Maturity and Evaluation Design

| Intervention Stage | Appropriate Evaluation Focus |
|---|---|
| Idea | Problem relevance and evidence review |
| Concept | Co-design and theory alignment |
| Prototype | Usability and accessibility |
| Feasibility | Acceptability, burden, and delivery feasibility |
| Pilot | Recruitment, retention, fidelity, and measurement feasibility |
| Evaluated | Mechanism, outcome, comparative, or implementation evaluation |
| Controlled Deployment | Effectiveness, safety, equity, and monitoring |
| Mature | Replication, scaling, and long-term impact |

### 9.3 Representative Designs

The platform should support:

- single-group feasibility studies;
- pre-post studies;
...
The selected design should preserve:

- design name and rationale;
- assignment method;
- comparator;
- blinding where applicable;
- observation, intervention, and follow-up periods;
- unit of assignment;
- unit of analysis;
- planned sample;
- stopping rules; and
...
## 11. Eligibility, Enrolment and Consent

### 11.1 Eligibility

Eligibility should be evaluated against an approved Protocol.
...
- relationship or Supporter availability only where required by the intervention;
- geography or Community eligibility;
- prior intervention exposure;
- ability to complete required participation with approved accessibility or support options;
- and consent, assent, or separately verified substitute-authority requirements where applicable.

### 11.2 Eligibility Decision

An `EligibilityDecision` should preserve:
...
Consent must be specific, understandable, voluntary, revocable, versioned, and linked to authorised activities and data uses.

### 11.5 Supported Decision-Making

Where appropriate, the platform should support communication assistance, accessible formats, authorised Supporter involvement, supported decision-making, assent, and separately verified substitute authority. The platform and AI Companion must not infer decision-making capacity from age, interface behaviour, Life Story content, emotional expression, or support needs.

### 11.6 Re-Consent

Re-consent may be required when:

- the Protocol materially changes;
- data use expands;
- AI behaviour changes materially;
- new risk emerges;
- follow-up extends;
- new devices are added;
- Life Story, Community, public visibility, matching, messaging or moderation use changes;
- matching attributes or ranking policies change;
- Internet Public publication is introduced;
- or external data sharing changes.


### 11.7 Canonical Enrolment State
...
An Active Enrolment may become Paused, Completed, Withdrawn, or Discontinued.

Paused participation is not withdrawal. Supporter assistance does not change whose decision is recorded.
...
## 26. Governed Community and Platform Public Participation Evaluation
...
- Life Story finding;
- Governed Community and social-connection finding;
...
Material research records should require accountable human review.

### 41.2 Representative Approvals
...
- Protocol approval;
- amendment approval;
- eligibility exception approval;
- safety review;
- Analysis Plan approval;
- dataset lock;
- interpretation approval;
- Research Finding approval; and
- external submission approval;
- high-impact moderation decision or appeal approval;
- Internet Public publication approval;
- sensitive matching-attribute or ranking-policy approval;
- and Dataset Version lock approval.

### 41.3 Separation of Duties

Where appropriate:

- the person analysing data should not be the sole approver;
- AI output should require human validation;
- safety-relevant decisions should require specialist review; and
- external submission should require separate authorisation.
...
### 49.1 MVP Research Capabilities

The MVP should include:

- Research Project creation;
- Research Question management;
- Protocol drafting and versioning;
- eligibility criteria;
...
- Outcome Records;
- Observation records;
- Safety Signal recording, triage and Safety Event confirmation workflow;
- adherence, exposure, fidelity, process, experience and burden measures;
- Life Story, Community, Open Matching, Connection and moderation evaluation records;
- Analysis Plan and Analysis Run records;
- Dataset Definition, Dataset Version, quality review and lock;
- descriptive and feasibility analysis support;
- Research Finding records;
- audit logging; and
- role-based approval.

### 49.2 MVP Evaluation Focus

The initial platform should prioritise:
...
- Participant burden;
- engagement and human-connection pathway;
- Life Story ownership, identity and burden;
- Community participation and public-exposure risk;
- Match Explanation, fairness, Mutual Acceptance and rejection burden;
- moderation, block, report, appeal and restoration;
- safety and privacy;
- AI grounding, tool, memory and Safety Signal behaviour;
- and early outcome signals.

The MVP should not claim definitive effectiveness without an appropriate study design.

### 49.3 MVP AI Evaluation
...
- citation accuracy;
- Safety Signals and Safety Events;
- Life Story invented-detail and correction;
- Community and matching tool actions;
- block, report and moderation assistance;
- Participant feedback;
- and human-connection outcomes.

### 49.4 MVP Research Flow
...
Define Research Question
        ↓
Approve Evidence Decision and Snapshot
        ↓
Create and Approve Protocol Version
        ↓
Screen, Consent and Enrol Participant
        ↓
Assign Exact Intervention Configuration
        ↓
Collect Baseline
        ↓
Deliver Life Story, Community and Open Matching Components
        ↓
Record Exposure, Assessment, Safety and Moderation
        ↓
Collect Follow-Up
        ↓
Generate and Quality Review Dataset Version
        ↓
Lock Dataset Version
        ↓
Approve Analysis Plan and Execute Analysis Run
        ↓
Approve Interpretation Record
        ↓
Approve Research Finding
        ↓
Record Intervention Decision
```


### 49.5 MVP Research Non-Goals

The MVP does not claim definitive effectiveness without an appropriate design and sample.

It does not include:

- automatic Protocol, Dataset Lock, Analysis Plan, Interpretation or Finding approval;
- unrestricted secondary use of Life Story, Community, matching or message data;
- hidden sensitive-trait matching analysis;
- Internet Public publication evaluation unless separately enabled and approved;
- automated Safety Event confirmation;
- autonomous high-impact moderation evaluation or decision;
- advanced causal inference;
- real-time wearable or smart-home outcome modelling;
- federated multi-site analysis;
- or engagement-maximising experimentation.
...
The Research & Evaluation Framework defines how the Digital Intervention Research Platform turns Healthy Aging challenges into accountable, evidence-generating research.

Its central lifecycle is:

```text
Question and Evidence Decision
        ↓
Protocol Version and Consent
        ↓
Enrolment and Exact Intervention Assignment
        ↓
Deliver and Record Actual Exposure
        ↓
Life Story, Community, Matching, Assessment, Safety and Moderation
        ↓
Dataset Definition, Quality Review and Lock
        ↓
Approved Analysis Plan and Analysis Run
        ↓
...
> A digital intervention is not successful because it was built, used, or liked. It must be evaluated for meaningful benefit, mechanism, burden, harm, accessibility, equity, and implementation in a defined population and context.

The Research Platform owns the research workflow.

The Knowledge Platform supplies governed evidence and knowledge services.

The AI Companion assists with research, evidence, Life Story, Community, matching, moderation and intervention delivery but remains subject to exact Protocol and AI configuration versions, evidence, consent, permissions, safety, minimum necessary context, reproducibility, and accountable human approval.
