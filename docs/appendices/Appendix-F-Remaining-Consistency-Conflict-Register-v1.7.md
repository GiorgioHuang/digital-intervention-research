...
**Version:** 1.7  
**Status:** Closed Consistency Register — Conceptual Research Mode; No Open Conflicts  
**Handbook Position:** Appendix F  
**Document Owner:** Architecture and Product Governance  
**Last Updated:** 2026-07-31  
**Supersedes:** Appendix F — Remaining Consistency Conflict Register v1.6  
...
- framework-level research rules versus conceptual-protocol choices;
...
| High | Can create incompatible domain, data, API or conceptual-model behaviour. |
...
| HR-006 | At the time of the full consistency review, Document 19 was correctly represented as Draft rather than prematurely presented as approved Protocol authority. |
...
| HR-022 | Project mode changed from real-Pilot preparation to conceptual and theoretical research. Documents 1, 11, 18, 19 and 20 and Appendices A, C, D and E now remove external approval as a current prerequisite while retaining governance concepts as future-system design objects. |
...
| HR-023 | The earlier Document 19 v1.2 approval record is retained as history but is non-canonical and superseded by the conceptual research mode in Document 19 v1.3. |
...
Document 19 v1.3 is an active conceptual research protocol. Theoretical research, synthetic simulation and non-production prototyping may begin immediately. Human-subject research and production deployment are separate future programmes.
