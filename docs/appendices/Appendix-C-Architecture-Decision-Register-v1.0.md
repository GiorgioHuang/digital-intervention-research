...
- first-Pilot decisions that remain subject to formal approval;
- intentionally deferred or prohibited capabilities;
- implementation decisions that must be resolved before their delivery gate;
...
| Accepted for Pilot | The decision governs the first Pilot/MVP and may be revisited after evidence. |
| Pending Approval | The architecture direction is documented but requires named governance, privacy, security, provider, ethics or operational approval. |
...
| ADR-009 | Modular Monolith for the MVP | Technical Architecture | Accepted for Pilot | Platform Architecture | D13; D18 | ATR-001; ATR-023; CHG-12; CHG-16 |
...
| ADR-012 | Single Physical Database with Logical Module Schemas | Data Architecture | Accepted for Pilot | Data and Platform Architecture | D13; D16 | ATR-001; ATR-022; CHG-12; CHG-15 |
...
| ADR-020 | Internet Public Disabled for the First Pilot | Pilot Scope | Accepted for Pilot | Product, Privacy and Research Governance | D18–D20 | CTL-004; ATR-002; ATR-021; CHG-16; CHG-17 |
...
| ADR-035 | One-to-One Messaging Only in the First Pilot | Pilot Scope | Accepted for Pilot | Product and Social Safety | D18–D20 | ATR-013–ATR-016; CHG-16 |
| ADR-036 | Read Receipts Disabled by Default | Messaging and Privacy | Accepted for Pilot | Product and Privacy Governance | D18–D20 | ATR-014; ATR-015; CHG-16; CHG-18 |
...
| ADR-048 | Prospective Single-Arm Mixed-Method Initial Pilot | Pilot Research Design | Pending Approval | Research Governance | D19 | OBJ-004; ATR-025; CHG-17 |
| ADR-049 | Staged Activation of Life Story, Community and Matching | Pilot Scope | Pending Approval | Research, Product and Safety Governance | D18; D19 | ATR-008; ATR-009; ATR-025; CHG-16; CHG-17 |
...
|---|---|
| Accepted | 46 |
| Accepted for Pilot | 5 |
| Pending Approval | 2 |
| Deferred | 5 |
| Prohibited | 2 |
| Open implementation decisions | 25 |
| Superseded legacy decisions | 6 |
...
#### ADR-049 — Staged Activation of Life Story, Community and Matching
...
| Decision | Stage activation: private Life Story/existing contact first, governed Community after readiness, and Open Matching/messaging after additional gates. |
| Alternatives Considered | Enable every social feature for every Participant on day one. |
| Rationale | Staging allows risk-controlled learning and feature-level pause. |
| Consequences | + Safer Pilot progression.<br>− Cohorts and exposure differ and require careful interpretation. |
| Verification | Approved Protocol, cohort configuration, feature flags and readiness evidence. |
| Review Trigger | Ethics decision, operational capacity or Pilot design amendment. |
...
#### ADR-048 — Prospective Single-Arm Mixed-Method Initial Pilot
...
| Decision | Use a prospective, single-arm, repeated-measure, mixed-method feasibility Pilot with staged feature activation. |
| Alternatives Considered | Randomised effectiveness trial; uncontrolled product analytics only. |
| Rationale | The Platform, intervention and operations need feasibility evidence before a larger comparative design. |
...
| Verification | Approved ProtocolVersion, ethics decision and AnalysisPlan. |
| Review Trigger | Governance/ethics feedback or a decision to pursue a comparative study. |
...
## 7. Open Implementation and Approval Decision Backlog

The following ADRs must be resolved before the named delivery or approval gate.

A proposed technology or provider in a ticket, prototype or code branch does not become authoritative until the ADR status and Appendix D/implementation references are updated.
...
| ADR-109 | AI Provider and Model Gateway Stack | Pending Approval | AI, Privacy and Security Governance | Select providers/models, gateway implementation, data-use terms, residency, fallback and evaluation policy. | Before AI activation | D17; D18 §223 | CHG-09; CHG-13 |
...
| ADR-111 | Communication Provider | Pending Approval | Platform, Privacy and Social Safety | Select provider/channel, callback security, delivery evidence, cancellation support, residency and retention. | Before MS-10 | D15; D18 §223 | CHG-12; CHG-13; CHG-14 |
| ADR-112 | Matching Algorithm and Attribute Registry | Pending Approval | Product, Research, Privacy and Social Safety | Approve permitted attributes, exclusions, candidate generation, explanation, expiry, fairness and audit. | Before Open Matching | D14 §51; D18 §223; D19 | CHG-02; CHG-10; CHG-16 |
| ADR-113 | Community Feed Ranking | Pending Approval | Product, Research and Social Safety | Choose chronological or governed ranking, allowed features, explanation, diversity and anti-amplification controls. | Before Community activation | D18 §223; D20 | CHG-16; CHG-18 |
...
| ADR-115 | Secure Analytical Environment | Pending Approval | Research Data, Security and Privacy Governance | Select environment, access, code/version capture, egress, audit and locked-Dataset ingestion. | Before MS-12 | D13 §51; D18 §223 | CHG-10; CHG-15 |
...
| ADR-117 | Message Body Encryption and Storage Strategy | Pending Approval | Security, Privacy and Data Architecture | Choose database field encryption, encrypted object storage or a hybrid with key, search and deletion implications. | Before MS-10 | D16 open questions | CHG-13; CHG-15 |
...
| ADR-119 | Approved Data Residency Regions | Pending Approval | Privacy, Legal and Security Governance | Approve database, object, backup, AI, communication and analytics locations and fallback restrictions. | Before provider contracts | D12–D16; D18 §223 | CHG-12; CHG-13; CHG-15 |
| ADR-120 | Retention Schedule | Pending Approval | Privacy, Research and Records Governance | Set retention for Consent, Life Story, Community, Messages, callback evidence, Safety, audit, datasets and research outputs. | Before recruitment | D14; D16; D18 §223 | CHG-13; CHG-15; CHG-17 |
| ADR-121 | Backup, RPO and RTO | Pending Approval | Platform, Security and Research Operations | Define backup coverage, point-in-time recovery, restore testing and service recovery targets. | Before Pilot readiness | D13 §51; D16; D18 §223 | CHG-12; CHG-15 |
...
| ADR-123 | Message Attachment Formats and Limits | Pending Approval | Product, Privacy, Security and Social Safety | Approve media types, size, scanning, preview, retention, reporting and accessibility. | Before MS-10 | D18–D20 open questions | CHG-16; CHG-18 |
| ADR-124 | Delivery Mapping and DeliveryUnknown Timeout | Pending Approval | Integration, Product and Research Governance | Define which provider evidence maps to Sent, ProviderAccepted, Delivered, Failed or Unknown and when reconciliation escalates. | Before MS-10 | D15; D18–D20 | CHG-14; CHG-16 |
| ADR-125 | MutualAcceptance Effective Period and Connection Acknowledgement | Pending Approval | Product, Research and Social Safety | Approve expiry duration, invalidation triggers and whether Connection activation requires an additional Participant acknowledgement. | Before Open Matching | D15–D20 open questions | CHG-16; CHG-17; CHG-18 |

### 7.1 Required Decision Package

An open ADR is ready for approval only when it includes:

- requirements and constraints;
- at least two credible alternatives unless only one compliant option exists;
- security, privacy and data-residency review;
- accessibility impact where Participant-facing;
- research and Dataset impact where applicable;
- provider data-use and retention terms;
- operational support and exit strategy;
- cost and capacity assumptions;
- proof of concept or benchmark where material;
...
## 10. Pilot-Critical ADR Gate

The following ADRs must be implemented and verified before real Participant recruitment:

- ADR-017 — Effective Permission;
- ADR-018 — Granular Consent;
- ADR-020 — Internet Public disabled;
- ADR-021 — Ability adaptation;
- ADR-023 and ADR-024 — Life Story authority;
- ADR-025 — Governed Community where activated;
- ADR-026–ADR-038 — matching, Connection, messaging and Block where activated;
- ADR-039 — SafetySignal/SafetyEvent;
- ADR-040–ADR-042 — AI authority and memory;
- ADR-044–ADR-049 — evidence, dataset and Pilot design;
- ADR-050–ADR-055 — security, accountability, providers, rights and degraded modes;
- and all applicable open ADRs ADR-101–ADR-125.

Document 19 remains Draft until governance and research ethics approval.
...
7. mark the ADR Accepted, Accepted for Pilot, Pending Approval, Deferred, Rejected or Prohibited;
...
- before a Pilot readiness decision;
...
| Initial Pilot | Design documented; governance and ethics approval pending |
| Providers and technical stack | Multiple ADRs remain Proposed or Pending Approval |
...
Appendix C v1.0 establishes the first complete Architecture Decision Register for the Documents 0–20 Handbook baseline.
