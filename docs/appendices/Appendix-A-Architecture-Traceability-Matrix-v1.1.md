...
**Version:** 1.1  
**Status:** Active Architecture Traceability Baseline  
...
Data, API, Runtime, Security and Storage
        ↓
Delivery Milestone and Pilot Protocol
        ↓
...
- governance and ethics preparation;
...
This appendix records **traceability coverage**. It does not claim that software is implemented, that a provider is contracted, that a Pilot is approved or that an intervention is effective.
...
8. Architecture coverage, implementation status, Pilot readiness and research approval are reported separately.
...
| DOC-18 | Document 18 | MVP Scope & Delivery Roadmap | 1.2 | Defines MVP scope, workstreams, milestones, gates, test strategy, readiness and success/failure criteria. | Reviewed | Document-18-MVP-Scope-and-Delivery-Roadmap-v1.2.md |
| DOC-19 | Document 19 | Initial Pilot Research Protocol | 1.2 | Defines the initial Pilot Protocol, Consent, cohort procedures, measures, thresholds and analysis plan boundary. | Reviewed — Draft | Document-19-Initial-Pilot-Research-Protocol-v1.2.md |
| DOC-20 | Document 20 | UX Flows & Design System Specification | 1.2 | Defines exact UX flows, state presentation, design-system components, accessibility tests and release defects. | Reviewed | Document-20-UX-Flows-and-Design-System-Specification-v1.2.md |
...
| CTL-017 | Audit and separation of duties | High-impact actions preserve actor, purpose, source, decision, conflict and immutable audit | D4 §§44–47, 70–76; D8 §54 | ApprovalRecord, AuditEvent, negative self-approval tests and Pilot readiness evidence | M15 and all action owners |
...
| MS-14 | Pilot Readiness | Research, UX, social safety, Safety, AI, data, security, technical and operations approvals | D18 §170 and §§193–202 | Formal readiness decision | All |
...
| ATR-002 | Participant-centred control | Participants retain understandable, reversible control over consent, content, matching, communication and withdrawal. | D1, D2 | D3–D5; D17/M18; D20 flows | Usability, Consent, visibility, Block and withdrawal tests | Covered; Pilot evidence pending |
...
| ATR-006 | Ability adaptation | Adaptation reduces burden without changing rights, intervention meaning or measurement interpretation. | D5 | D2 conceptual rules; D11 evaluation; D20 UX | Accessibility, semantic-equivalence and adaptation-fidelity tests | Covered; Pilot evidence pending |
...
| ATR-021 | Security and privacy | Sensitive data are protected by deny-by-default, purpose limitation, encryption, secure providers and incident response. | D4/D14 | D13, D15–D17 | Security acceptance, penetration, provider and recovery tests | Architecture covered; formal approval pending |
...
| ATR-025 | Pilot launch gate | Real recruitment requires Protocol approval, ethics/governance, providers, staffing and readiness sign-off. | D18/D19 | D20 release blockers; governance appendices | Signed readiness package and approval references | Pending formal approval |
...
| Covered; Pilot evidence pending | Architecture is complete, but real-Participant evidence has not yet been collected. |
| Architecture covered; formal approval pending | Design exists, but a formal security, privacy, governance, ethics or provider approval remains. |
| Pending formal approval | The requirement cannot be considered launch-ready until the named approval is complete. |
...
| CHG-16 | MVP scope, milestone or feature flag | D18 | D3, D6–D17, D19, D20 | Update readiness, synthetic scenarios, Protocol and UX activation. |
| CHG-17 | Pilot Protocol amendment | D19 | D4, D8, D11–D18, D20 | Create new ProtocolVersion; assess re-consent, ethics and Dataset/Analysis changes. |
...
| Research and evaluation | Complete architecture | Pilot data and Findings do not yet exist |
...
| Initial Pilot Protocol | Revalidated Draft | Document 19 remains Draft; governance and research ethics approval pending |
