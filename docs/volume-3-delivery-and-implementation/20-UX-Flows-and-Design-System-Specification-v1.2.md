...
**Version:** 1.2  
**Status:** Revised UX and Design System Baseline — M18 Messaging and State Revalidated  
...
- and usability and acceptance criteria.

The central UX rule is:

> The interface must reduce unnecessary burden without hiding authority, Consent, purpose, visibility, uncertainty, provenance, social consequence or research state.
...
- role and workspace strategy;
- global and contextual navigation;
- protected existence;
- Permission and Consent presentation;
- lifecycle, review, approval and delivery states;
- visibility and audience selection;
- Participant, Researcher, Supporter, Moderator, Safety and Administration flows;
- Life Story;
- PublicProfile;
- Community;
- Open Matching;
...
- AI Companion;
- DatasetDefinition, DatasetLock, AnalysisRun and ResearchFinding;
- forms, tables, cards, timelines and charts;
- loading, empty, offline, degraded and conflict states;
- accessibility and ability adaptation;
- responsive design;
...
- design tokens;
- reusable components;
- usability, accessibility, social-safety and AI testing;
- UX analytics;
...
`ConnectionRequest` is hidden and feature-disabled for the first Pilot.
...
Internet Public requires a separate publication flow and is disabled by default for the Pilot.
...
## 72. Researcher Flow — Recruitment and Enrolment
...
## 92. Participant Flow — Invitation
...
## 93. Participant Flow — Account Activation
...
## 94. Participant Flow — Study Introduction
...
ConnectionRequest is not shown in the first Pilot.
...
Emergency wording must be approved for the Pilot setting.
...
ConnectionRequest and group messaging are not designed as active first-Pilot flows.
...
- anonymous Platform Public or Community participation;
...
## 359. Pilot UX Readiness

Pilot UX readiness requires:

- approved flows and content;
- critical prototypes;
- representative usability testing;
- accessibility testing;
- social-safety testing;
- MatchDecision and MutualAcceptance comprehension testing;
- CommunicationBasis comprehension testing;
- Message confirmation and delivery-state testing;
- Provider Accepted versus Delivered comprehension testing;
- Block and pending-delivery explanation testing;
- AI UX testing;
- error-recovery testing;
- design QA;
- component documentation;
- Moderator and Safety workflow validation;
- support handoff;
- and no unresolved release-blocking usability defect.

Testing must include low digital confidence, assistive technology and degraded provider scenarios.

## 360. UX Release-Blocking Defects

Release-blocking defects include:

- inaccessible Consent;
- inaccessible withdrawal;
- inability to identify audience;
- unintended Life Story publication;
- Block unavailable or ineffective;
- MatchDecision ambiguity;
- MutualAcceptance shown before confirmation or after invalidation;
- Connection shown active without valid activation;
- Message composer available without CommunicationBasis;
- Message sent without exact clear confirmation;
- editing after confirmation without re-confirmation;
- Provider Accepted shown as Delivered;
- Delivery Unknown hidden or shown as success;
- false claim that Block recalled an external Message;
- reporter identity exposure;
- SafetySignal shown as confirmed SafetyEvent;
- AI Draft shown as final;
- AI-created Connection or send authority;
- DatasetLock interaction shown as locked before M12 confirmation;
- and critical action inaccessible by keyboard or screen reader.
...
- managed identity;
- and one controlled Pilot context.
...
1. Which Participant device profile is primary?
2. Is responsive web sufficient for every Pilot activity?
3. Which authentication method is most accessible?
4. Which accessibility modes are mandatory at launch?
5. Is voice input enabled?
6. Is read-aloud enabled?
7. Which Participant flows may be completed with Supporter assistance?
8. Which Consent sections require knowledge checks?
9. Which Life Story prompts are approved?
10. Which Life Story media types are enabled?
11. Are Supporter contributions enabled?
12. Is LegacyPreference hidden for the entire Pilot?
13. Which Life Story sharing rights are available?
14. Is Platform Public enabled?
15. Is Internet Public disabled throughout the Pilot?
16. Which PublicProfile fields are allowed?
17. Which CommunitySpaces are enabled?
18. Are reactions and comments enabled?
19. Which matching attributes are shown in MatchExplanation?
20. How is candidate expiry explained?
21. Which MatchDecision values are reversible?
22. How is the other actor's private decision protected?
23. How is MutualAcceptance expiry or invalidation explained?
24. Does Connection activation require a separate button?
25. Which CommunicationBasis labels are understandable?
26. May an authorised Relationship create a Thread without Connection?
27. Which Message formats are enabled?
28. Which attachments are enabled?
29. Are read receipts disabled throughout the Pilot?
30. Which delivery states are shown in the compact Thread view?
31. What label best explains Provider Accepted?
32. How is Delivery Unknown explained without creating anxiety?
33. How is retry risk explained?
34. How is pending-delivery cancellation after Block explained?
35. Which provider details remain hidden?
36. Which moderation outcomes may be shown to reporters?
37. Which Safety urgency states require interruptive presentation?
38. Which AI entry points are enabled?
39. How is AI Draft involvement labelled?
40. Which AI Tool confirmations use step-up authentication?
41. Which DatasetLock confirmation content is required?
42. Which UX Analytics events are required for the Pilot?
43. Which analytics events require delayed domain-result correlation?
44. Which offline or partial-outage states are supported?
45. Which release-blocking defects trigger feature versus study pause?
46. Which flows require formal usability evidence before activation?

## 364. Design Decisions

This document establishes that:

1. Document 20 v1.2 is the authoritative Handbook source for UX flows and design-system specification.
2. The UX is role-specific rather than one generic application.
3. Participant, Researcher, Supporter, Moderator, Safety and Administration workspaces remain distinct.
4. Workspace switching is deliberate and does not merge permission.
5. Active Organisation, ResearchProject and workspace context remain visible.
6. Navigation is server-authority aligned.
7. Client-side hiding is not authorisation.
8. Protected existence prevents resource disclosure.
9. Participant Home is task-oriented rather than feed-first.
10. Persistent Participant controls include Consent, Help, Block, Report and withdrawal.
11. Researcher UX prioritises versioning, traceability and approval.
12. Moderator UX prioritises evidence minimisation and reporter protection.
13. Safety UX prioritises urgency and accountable human triage.
14. Administration does not confer research, moderation or Safety authority.
15. Ability adaptations do not change rights or domain meaning.
16. Private is the default Life Story and social Visibility.
17. Platform Public and Internet Public are visually distinct.
18. Internet Public is disabled by default.
19. Open Matching is opt-in.
20. MatchCandidate is not mutual interest.
21. MatchDecision is actor-owned.
22. MutualAcceptance is shown only after M18 confirms it.
23. MutualAcceptance expired and invalidated states are visible where relevant.
24. Connection activation is separate from MutualAcceptance.
25. Connection does not imply Supporter or research authority.
26. ConnectionRequest is hidden and feature-disabled.
27. CommunicationBasis is shown or explained before messaging.
28. ConversationThread is unavailable when its basis is ineffective.
29. Thread participants are explicit.
30. Message begins as Draft.
31. Save Draft and Send are separate.
32. SendConfirmation binds actor, exact Message version and recipients.
33. Editing after confirmation requires re-confirmation.
34. Queued, Sent, Provider Accepted, Delivered, Read, Failed and Unknown are distinct.
35. Provider Accepted is not Delivered.
36. Read receipts are disabled by default.
37. Delivery Unknown is shown honestly.
38. Retry preserves the logical Message and may create another DeliveryAttempt.
39. Withdrawal does not imply external recall.
40. AI Draft is clearly labelled and remains editable.
41. AI cannot create MutualAcceptance, Connection, Thread or sender authority.
42. Block explains immediate Platform effects and external-delivery limitations.
43. Block revocation does not restore prior matching or messaging state.
44. Report remains accessible after Block or Disconnect.
45. ModerationCase and SafetyEvent remain separate in UX.
46. SafetySignal is not shown as confirmed SafetyEvent.
47. UX Analytics Event is not a Domain Event.
48. Domain completion is shown only after owning-domain confirmation.
49. DatasetLockConfirmationSubmitted is not DatasetVersionLocked.
50. MessageDeliveryConfirmed is not a canonical event name.
51. Errors preserve Drafts and explain safe recovery.
52. Critical controls fail closed when authority cannot be verified.
53. The design system includes state, confirmation, audience, source and uncertainty components.
54. Accessibility testing includes social, messaging and degraded-provider states.
55. Release-blocking defects include false authority and false delivery presentation.
56. Group messaging, direct ConnectionRequest and Internet Public flows are deferred.
57. Version 1.2 completes UX revalidation against Documents 8, 12, 13, 15, 16, 18 and 19.

## 365. Summary

The UX architecture is:
...
Task-Oriented Flow
        ↓
Visible Source, State, Audience and CommunicationBasis
        ↓
...
Owning-Domain Result
        ↓
Accurate Delivery, Failure or Pending State
        ↓
Receipt, Recovery, Block, Report or Withdrawal
```

The canonical Participant messaging experience is:

```text
Connection or Another Approved CommunicationBasis
        ↓
ConversationThread
        ↓
Message Draft
        ↓
Review Exact Version and Recipients
        ↓
SendConfirmation
        ↓
Queued
...
> The interface may simplify effort, but it must never simplify away authority, audience, basis, exact state, uncertainty, failure, external-provider limitation or Participant control.

Document 20 v1.2 completes the downstream revalidation of the revised M18 model.
