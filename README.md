...
| know why something was built that way | `design/DESIGN_DECISIONS.md` (D-1…D-99) and `governance/IMPLEMENTATION_DECISIONS.md` (the ADR dispositions) |
...
`design/DESIGN_DECISIONS.md` is the most useful file for understanding the project's character: ninety-nine rulings, most of them recording something that looked finished and was not.
