...
`design/DESIGN_DECISIONS.md` is the most useful file for understanding the project's character: eighty-nine rulings, most of them recording something that looked finished and was not.
